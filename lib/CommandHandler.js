...
const { Peer, PeerCommunicationHandler } = require('./PeerCommunication');
class CommandHandler {
    ...
    static async downloadPieceCommand(arg1, arg2, arg3) {
        ...
        peerCommunicationHandler.downloadPieceTo(filePath, pieceIndex)
        .then(() => {
    ...
    static async downloadCommand(arg1, arg2) {
        ...
        peerCommunicationHandler.downloadTo(filePath)
        .then(() => {
